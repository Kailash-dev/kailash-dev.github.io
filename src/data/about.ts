  ...
  workingStyle: [
    {
      ...
      description:
        "Every engagement starts with business goals. Technical choices serve those goals — not the other way around.",
    },
    {
      title: "Transparent delivery",
      description:
        "Regular progress updates, honest timelines, and early flagging of risks. No black boxes.",
    },
    {
      title: "Senior judgment",
      description:
        "Architecture, stack decisions, and trade-offs handled with experience — so you avoid costly rework.",
    },
    {
      title: "International collaboration",
      description:
        "Structured async work with clients across US, Canada, UK, Europe, and Australia.",
    },
  ],
  capabilities: [
