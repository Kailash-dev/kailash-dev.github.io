...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className={`relative mx-auto ${layout.container.default} ${layout.section.paddingX}`}>
        <div className="max-w-3xl">
          <p className="text-sm font-medium text-muted-foreground">{siteConfig.title}</p>
          <h1 className="text-balance mt-4 text-5xl font-semibold tracking-tight md:text-6xl lg:text-7xl"><span className="text-primary">Trusted by founders and teams worldwide</span> - 
          ...
          <p className="text-pretty mt-4 max-w-2xl text-base text-muted-foreground">
            For founders and teams who need a senior partner — not another vendor — to
            design, build, and ship software with clarity and accountability.
          </p>
